...
export const selectWalkthroughSliceByScreenNameAndListOrder = (
  state,
  screenName = "",
  listOrder = 1
) => {
  return state.walkthrough.walkthroughes.find(
    (item) => item.screenName === screenName && item.listOrder === listOrder
  );
};
